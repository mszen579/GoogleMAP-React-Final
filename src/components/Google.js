                              ...
                              <td className="VenueList-secCol"> <li> <h3> {item.name} </h3></li> </td>
                                 ...
                                 {item.location.address !== undefined ?
                                  ...
                                  :
                                   <tr>
                                       ...
                                       <td className="VenueList-secCol"> <li> Map </li></td>
                                   </tr>
                                 }
                                 ...
                                 {item.categories[0].name !== undefined ?
                                   <tr>
                                     ...
                                     <td className="VenueList-secCol">  <li> {item.categories[0].name} </li>
                                     <li> <a className="btn btn-success" href={"https://maps.google.com/?q="+ item.location.address}>See it on Google maps</a></li>
                                      </td>
                                  ...
                                  :
                                   <tr>
                                      <td className="VenueList-firstCol"><li> Category Name: </li> </td>
                                      <td className="VenueList-secCol">  <li> Not Available </li> <li> MAP Not Available </li></td>
                                   </tr>
                                 }
